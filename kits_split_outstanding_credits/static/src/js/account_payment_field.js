/** @odoo-module **/
//This JS File is replace from "account/static/src/components/account_payment_field/account_payment_field.js"
//This File is replace for modify "assignOutstandingCredit" this method
...
export class AccountPaymentField extends Component {
    ...
    async assignOutstandingCredit(id) {
        //IN this method we opening wizard if outstanding credit split setting enable
        //Otherwise otherwise original method run
        try {
            const action = await this.orm.call(
              this.props.record.resModel,
              'open_prepayment_wizard_action',
              [this.move_id, id],
              {}
            );
            ...
            if (action && typeof action === 'object') {
              this.action.doAction(action); 
                ...
                //This is orijinal methot statrt
            ...
            console.error('Error in assignOutstandingCredit:', error);
          }
        }
